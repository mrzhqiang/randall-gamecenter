...
public final class Share {
  ...
  public void loadConfig() {
    if (ini.get(BASIC_SECTION_NAME) != null) {
      ...
      // 这里可以替代上面
      config.getHome().read(ini.get(BASIC_SECTION_NAME));
    }
    if (ini.get(DB_SERVER_SECTION_NAME) != null) {
      ...
      config.getDatabase().read(ini.get(DB_SERVER_SECTION_NAME));
    }
    if (ini.get(LOGIN_SRV_SECTION_NAME) != null) {
      ...
      config.getAccount().read(ini.get(LOGIN_SRV_SECTION_NAME));
    }
    if (ini.get(M2_SERVER_SECTION_NAME) != null) {
      ...
      config.getCore().read(ini.get(M2_SERVER_SECTION_NAME));
    }
    if (ini.get(LOG_SERVER_SECTION_NAME) != null) {
      ...
      config.getLogger().read(ini.get(LOG_SERVER_SECTION_NAME));
    }
    if (ini.get(RUN_GATE_SECTION_NAME) != null) {
      ...
      config.getRun().read(ini.get(RUN_GATE_SECTION_NAME));
    }
    if (ini.get(SEL_GATE_SECTION_NAME) != null) {
      ...
      config.getRole().read(ini.get(SEL_GATE_SECTION_NAME));
    }
    if (ini.get(LOGIN_GATE_SECTION_NAME) != null) {
      ...
      config.getLogin().read(ini.get(LOGIN_GATE_SECTION_NAME));
    }
    if (ini.get(PLUG_TOP_SECTION_NAME) != null) {
      ...
      config.getTop().read(ini.get(PLUG_TOP_SECTION_NAME));
    }
  }
  ...
  public void saveConfig() {
    ...
    config.getHome().write(ini.get(BASIC_SECTION_NAME));
    config.getAccount().write(ini.get(LOGIN_SRV_SECTION_NAME));
    config.getDatabase().write(ini.get(DB_SERVER_SECTION_NAME));
    config.getCore().write(ini.get(M2_SERVER_SECTION_NAME));
    config.getLogger().write(ini.get(LOG_SERVER_SECTION_NAME));
    config.getRun().write(ini.get(RUN_GATE_SECTION_NAME));
    config.getRole().write(ini.get(SEL_GATE_SECTION_NAME));
    config.getLogin().write(ini.get(LOGIN_GATE_SECTION_NAME));
    try {
      ini.store();
    } catch (IOException e) {
